...
// one quantum.
{
  ...
  // `node --version` stays upstream's v26.7.0 so semver tooling is untouched,
  // and RexMirror.info.banner is what a log line prints to say which build is
  // running.  Append an entry when a binary ships; the last one is current.
  // Plain prototypes on purpose: console.log(RexMirror.info) should read clean.
